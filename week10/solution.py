"""
Week 10: Multi-Pass Cleaning

Focus: After time passes and tiles become dirty again, the agent
can perform a second (or third) cleaning pass. The agent handles
the full cleaning cycle — clean, wait, clean again.
...
class FloorCleaningAgent:
    """Agent that can perform multiple cleaning passes over time."""
    ...
    def move_up(self):
        raise NotImplementedError("Implement in Week 10")
    ...
    def clean(self):
        """Main cleaning routine. Performs a zigzag sweep of all tiles."""
        raise NotImplementedError("Implement in Week 10")
