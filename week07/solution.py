"""
Week 07: Multiple Obstacles

Focus: The agent can clean a room with several obstacles placed
in various positions, navigating around all of them.
...
class FloorCleaningAgent:
    """Agent that can clean a room with multiple obstacles."""
