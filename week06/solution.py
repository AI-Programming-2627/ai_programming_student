"""
Week 06: Navigate Around a Single Obstacle

Focus: The agent can clean a room that contains one obstacle,
navigating around it to reach all tiles.
...
class FloorCleaningAgent:
    """Agent that can navigate around a single obstacle."""
    ...
    def move_up(self):
        raise NotImplementedError("Implement in Week 06")
    ...
    def _navigate_to(self, target_x, target_y):
        """Navigate the agent to (target_x, target_y) avoiding obstacles."""
        raise NotImplementedError("Implement in Week 06")

    def clean(self):
        """Clean the entire room, navigating around obstacles."""
        raise NotImplementedError("Implement in Week 06")
