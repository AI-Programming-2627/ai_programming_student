"""
Week 04: Empty Room Sweep — Zigzag Cleaning

Focus: Implementing the clean() method that sweeps an empty room
row by row (boustrophedon / zigzag pattern) without obstacles.
...
class FloorCleaningAgent:
    """Agent that can perform a full zigzag sweep of an empty room."""
    ...
    def move_up(self):
        raise NotImplementedError("Implement in Week 04")
    ...
    def update_model(self):
        ...
        # Check bump sensors for each direction
    ...
    def clean(self):
        """Main cleaning routine: zigzag sweep of the entire room."""
        raise NotImplementedError("Implement in Week 04")
